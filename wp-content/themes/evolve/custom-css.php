...
$evolve_main_pattern = evolve_get_option('evl_pattern','none');
...
.widgets-back ul ul ul {
    list-style-image:url(' . $template_url . '/library/media/images/dark/list-style-dark.gif) !important;
}
...
if (( $evolve_tagline_pos !== "disable" ) && ( $evolve_tagline_pos == "under" )|| ( $evolve_tagline_pos == "above" )){
	$evolve_css_data .= '
...
//Content font
$evolve_css_data .= evolve_print_fonts('evl_content_font', ' textarea, .entry-content ', $additional_css = 'line-height:1.5em', $additional_color_css_class = 'body');
...
$padding_top = evolve_get_option('evl_header_padding_top');
$padding_bottom = evolve_get_option('evl_header_padding_bottom');
...
if ($header_image_src) {
    $evolve_css_data .= '
	.custom-header { 
	background:url(' . esc_url($header_image_src) . ') ' . $background_position . ' ' . $background_repeat . ';
	border-bottom:0;
...
if ($footer_image_src) {
    $evolve_css_data .= '
.footer {
	background:url(' . esc_url($footer_image_src) . ') ' . $footer_background_position . ' ' . $footer_background_repeat . ';
...
.custom-header {
	position:relative;
	background:url(' . esc_url($header_image_src) . ') top center no-repeat;
	border-bottom:0;
}
	';
}
...
$evolve_shortcode_button_size = evolve_get_option('evl_shortcode_button_size');
$evolve_shortcode_button_shape = evolve_get_option('evl_shortcode_button_shape');
$evolve_shortcode_button_type = evolve_get_option('evl_shortcode_button_type');
$evolve_shortcode_button_gradient_top_color = evolve_get_option('evl_shortcode_button_gradient_top_color'); 
$evolve_shortcode_button_gradient_bottom_color = evolve_get_option('evl_shortcode_button_gradient_bottom_color');
$evolve_shortcode_button_gradient_top_hover_color = evolve_get_option('evl_shortcode_button_gradient_top_hover_color');
$evolve_shortcode_button_gradient_bottom_hover_color = evolve_get_option('evl_shortcode_button_gradient_bottom_hover_color');
$evolve_shortcode_button_accent_color = evolve_get_option('evl_shortcode_button_accent_color'); 
$evolve_shortcode_button_accent_hover_color = evolve_get_option('evl_shortcode_button_accent_hover_color');
$evolve_shortcode_button_bevel_color = evolve_get_option('evl_shortcode_button_bevel_color');
$evolve_shortcode_button_border_color = evolve_get_option('evl_shortcode_button_border_color');
$evolve_shortcode_button_border_hover_color = evolve_get_option('evl_shortcode_button_border_hover_color'); 
$evolve_shortcode_button_border_width = evolve_get_option('evl_shortcode_button_border_width');
$evolve_shortcode_button_shadow = evolve_get_option('evl_shortcode_button_shadow'); 

...
function evolve_sharethis() {
    ...
    <div class="share-this">
        ...
        <a rel="nofollow" class="tipsytext" title="<?php _e('Share on Pinterest', 'evolve'); ?>" target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>"><i class="t4p-icon-social-pinterest"></i></a>

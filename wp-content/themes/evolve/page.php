                    ...
                    <div class="letra-home text-center">
                        ...
                        <div class="mapa">
                            <div class="col-md-3 text-center">
                                ...
                                if($idioma == "en"){
                                ?>
                                <a class="" href="/en/marinas-turisticas/">
                                    <img class="img_top_map" src="/wp-content/themes/evolve/mapa/ico_marina grande.png"> Tourism Marinas
                                </a>
                                <?php
                                }
                                ?>
                            ...
                            <div class="col-md-3 text-center">
                                ...
                                if($idioma == "en"){
                                ?>
                                <a href="/en/bases-nauticas/">
                                    <img class="img_top_map" src="/wp-content/themes/evolve/mapa/ico_bases grande.png"> Nautical Bases
                                </a>
                                <?php
                                }
                                ?>
                            ...
                            <div class="col-md-3 text-center ">
                                ...
                                if($idioma == "en"){
                                ?>
                                <a href="/en/centros-de-buceo/">
                                    <img class="img_top_map" src="/wp-content/themes/evolve/mapa/centro_buceo.png"> International Diving Centers
                                </a>
                                <?php
                                }
                                ?>
                            ...
                            <div class="col-md-3 text-center ">
                                ...
                                ?>
                                <a href="/faros-con-vigilancia/">
                                    <img class="img_top_map" style="height: 35px" src="/wp-content/themes/evolve/mapa/TODO_Cuba copia.bmp"> Surveillance headlights
                                </a>
                                <?php
                                }
                                ?>
